...
sudo apt install qemu-system uml-utilities git wget libguestfs-tools p7zip-full make tesseract-ocr tesseract-ocr-eng vim net-tools screen neofetch -y
...
# Modify & Launching VM
clear
echo Modify your VM options, Exit to use default options.
wait 6
sudo nano ./vm.sh
echo Modified.
wait 6
